...
folder_name = "immigration-automation"
if not os.path.exists(folder_name):  # If folder doesn't exist...
    os.mkdir(folder_name)  # ...then create it!
else:
    print(f"Folder '{folder_name}' already exists!")  # Optional message
os.chdir("immigration-automation")  # Change directory properly
# Install basic packages
import subprocess
subprocess.run(["pip", "install", "streamlit", "easyocr", "opencv-python", "pillow", "pandas"])
...
# Replace all folder creations with this pattern:
os.makedirs("immigration-automation", exist_ok=True)
